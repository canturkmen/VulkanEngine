...
namespace VulkanEngine {
	...
	{
		vkDestroyShaderModule(m_VulkanDevice.device(), fragmentShaderModule, nullptr);
		vkDestroyShaderModule(m_VulkanDevice.device(), vertexShaderModule, nullptr);
	...
	void VulkanEnginePipeline::createGraphicsPipeline(const std::string& vertexFilePath, const std::string& fragmentShaderFilePath, const PipelineConfigInfo& configInfo)
	{
		...
		auto bindingDescriptions = VulkanModal::Vertex::getBindingDescription();
		auto attributeDescriptions = VulkanModal::Vertex::getAttributeDescriptions();
